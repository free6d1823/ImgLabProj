// iViewer.cpp : Defines the class behaviors for the application.
//
...
{
	static char strFilter[] = "JPEG(*.jpg)|*.jpg|""BMP Files(*.bmp)|*.bmp|" 
				"All Files(*.*)|*.*||";
	CString newName;
	CString title;
	VERIFY(title.LoadString(AFX_IDS_OPENFILE));
	CFileDialog dlgFile(TRUE, ".bmp",  0, OFN_HIDEREADONLY | OFN_FILEMUSTEXIST, strFilter, 0, 0, TRUE);
